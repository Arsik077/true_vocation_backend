...
public class AnswerResource {
    ...
    public ResponseEntity<List<AnswerDTO>> getAllAnswers(
        ...
        if ("answeruser-is-null".equals(filter)) {
            log.debug("REST request to get all Answers where answerUser is null");
            return new ResponseEntity<>(answerService.findAllWhereAnswerUserIsNull(), HttpStatus.OK);
        }
