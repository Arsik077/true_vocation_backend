...
public class SubjectResource {
     ...
     */
    @GetMapping("/subjects")
    public ResponseEntity<List<SubjectDTO>> getAllSubjects(@org.springdoc.api.annotations.ParameterObject Pageable pageable) {
