package com.truevocation.main.comment_answer.controller;
...
import com.truevocation.main.comment_answer.service.CommentAnswerService;
...
/**
 * REST controller for managing {@link CommentAnswer}.
 */
@RestController
@RequestMapping("/api")
