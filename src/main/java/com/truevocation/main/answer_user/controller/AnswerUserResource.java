package com.truevocation.main.answer_user.controller;

import com.truevocation.main.answer_user.entity.AnswerUser;
import com.truevocation.main.answer_user.repository.AnswerUserRepository;
import com.truevocation.main.answer_user.service.AnswerUserService;
import com.truevocation.main.answer_user.dto.AnswerUserDTO;
...
/**
 * REST controller for managing {@link AnswerUser}.
 */
@RestController
@RequestMapping("/api")
