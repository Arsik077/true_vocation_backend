...
import com.truevocation.main.contact.controller.ContactResource;
import com.truevocation.main.contact.entity.Contact;
import com.truevocation.main.contact.repository.ContactRepository;
...
class ContactResourceIT {
    ...
    public static Contact createEntity(EntityManager em) {
        Contact contact = new Contact().type(DEFAULT_TYPE).contact(DEFAULT_CONTACT);
        return contact;
    }
    ...
    public static Contact createUpdatedEntity(EntityManager em) {
        Contact contact = new Contact().type(UPDATED_TYPE).contact(UPDATED_CONTACT);
        return contact;
    }
    ...
    void putNewContact() throws Exception {
        ...
        updatedContact.type(UPDATED_TYPE).contact(UPDATED_CONTACT);
    ...
    void fullUpdateContactWithPatch() throws Exception {
        ...
        partialUpdatedContact.type(UPDATED_TYPE).contact(UPDATED_CONTACT);
