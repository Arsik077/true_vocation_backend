...
import com.truevocation.main.subject.controller.SubjectResource;
import com.truevocation.main.subject.entity.Subject;
import com.truevocation.main.subject.repository.SubjectRepository;
...
class SubjectResourceIT {
    ...
    public static Subject createEntity(EntityManager em) {
        Subject subject = new Subject().name(DEFAULT_NAME).picture(DEFAULT_PICTURE);
        return subject;
    }
    ...
    public static Subject createUpdatedEntity(EntityManager em) {
        Subject subject = new Subject().name(UPDATED_NAME).picture(UPDATED_PICTURE);
        return subject;
    }
    ...
    void createSubject() throws Exception {
        ...
        assertThat(testSubject.getPicture()).isEqualTo(DEFAULT_PICTURE);
    }
    ...
    void putNewSubject() throws Exception {
        ...
        updatedSubject.name(UPDATED_NAME).picture(UPDATED_PICTURE);
        ...
        assertThat(testSubject.getPicture()).isEqualTo(UPDATED_PICTURE);
    }
    ...
    void fullUpdateSubjectWithPatch() throws Exception {
        ...
        partialUpdatedSubject.name(UPDATED_NAME).picture(UPDATED_PICTURE);
