...
import com.truevocation.main.question.controller.QuestionResource;
import com.truevocation.main.question.entity.Question;
import com.truevocation.main.question.repository.QuestionRepository;
import com.truevocation.main.question.service.QuestionService;
...
class QuestionResourceIT {
    ...
    public static Question createUpdatedEntity(EntityManager em) {
        Question question = new Question().question(UPDATED_QUESTION);
        return question;
    }
    ...
    void putNewQuestion() throws Exception {
        ...
        updatedQuestion.question(UPDATED_QUESTION);
    ...
    void partialUpdateQuestionWithPatch() throws Exception {
        ...
        partialUpdatedQuestion.question(UPDATED_QUESTION);
