...
import com.truevocation.main.course.controller.CourseResource;
import com.truevocation.main.course.entity.Course;
import com.truevocation.main.course.repository.CourseRepository;
...
class CourseResourceIT {
    ...
    public static Course createEntity(EntityManager em) {
        Course course = new Course().name(DEFAULT_NAME).description(DEFAULT_DESCRIPTION).picture(DEFAULT_PICTURE);
        return course;
    }
    ...
    public static Course createUpdatedEntity(EntityManager em) {
        Course course = new Course().name(UPDATED_NAME).description(UPDATED_DESCRIPTION).picture(UPDATED_PICTURE);
        return course;
    }
    ...
    void putNewCourse() throws Exception {
        ...
        updatedCourse.name(UPDATED_NAME).description(UPDATED_DESCRIPTION).picture(UPDATED_PICTURE);
    ...
    void partialUpdateCourseWithPatch() throws Exception {
        ...
        partialUpdatedCourse.picture(UPDATED_PICTURE);
    ...
    void fullUpdateCourseWithPatch() throws Exception {
        ...
        partialUpdatedCourse.name(UPDATED_NAME).description(UPDATED_DESCRIPTION).picture(UPDATED_PICTURE);
